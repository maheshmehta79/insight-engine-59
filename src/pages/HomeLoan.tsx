      ...
      <div className="flex gap-8 pb-16">
        ...
        <aside className="hidden lg:block w-[280px] shrink-0">
          <div className="sticky top-24">
            ...
            <SidebarCard title="Home Loan by Bank" items={homeLoanByBank} icon={Building2} />
            <SidebarCard title="Interest Rate by Bank" items={interestRateByBank} icon={BadgePercent} />
            <SidebarCard title="Home Loan Details" items={homeLoanDetails} icon={Home} />

            {/* CTA Card */}
            <div className="rounded-xl bg-[hsl(var(--purple-deep))] p-5 text-white">
              <Home className="w-8 h-8 text-white/80 mb-3" />
              <h3 className="text-sm font-bold mb-1">Get Best Home Loan Offer</h3>
              <p className="text-xs text-white/70 mb-4">Compare offers from 20+ banks and get the lowest rates for your dream home.</p>
